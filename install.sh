...
# Detect OS (Linux only by security policy)
os_type=$(uname -s)
case $os_type in
    Linux)
        os_name="linux"
...
if [ -n "$github_proxy" ]; then
    ...
    download_url="${github_proxy}/https://github.com/luck159156/tz/releases/${download_path}/${file_name}"
else
    # Direct access to GitHub releases
    download_url="https://github.com/luck159156/tz/releases/${download_path}/${file_name}"
fi
